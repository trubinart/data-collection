...
class InstagramSpider(scrapy.Spider):
    ...
    insta_login = settings.INSTA_LOGIN
    insta_pwd = settings.INSTA_PASSWORD
    inst_login_link = 'https://www.instagram.com/accounts/login/ajax/'
    parse_user = ['rumonikitinn', '_._arya_._05']  # Пользователь, у которого собираем посты. Можно указать список

    graphql_url = 'https://www.instagram.com/graphql/query/?'
    query_hash = '02e14f6a7812a876f7d133c9555b1151'  # hash для получения данных по постах с главной страницы

    def parse(self, response):  # Первый запрос на стартовую страницу
    ...
    def body_parse(self, response, username, user_id, type,
